...
def load_and_preprocess(case, patient_name, output_folder):
    ...
    print(join(output_folder, patient_name + ".npy"))
...
if __name__ == "__main__":
    ...
    if args.year == 2020:
        ...
        args = init_args()
        data_file_path = "/content/gdrive/MyDrive/PrasunFolder/BraTS2020/Dataset/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData"
        npy_normalized_folder = join(data_file_path, "npy")
        print(npy_normalized_folder)
    ...
    if args.year == 202001 or args.year == 202002:
        ...
        if args.year == 202001:
            data_file_path = "/content/gdrive/MyDrive/PrasunFolder/BraTS2020/2Stage_VAE/Dataset/BraTS2020_TrainingData/data/MICCAI_BraTS2020_ValidationData"
        ...
        name_mapping = pd.read_csv(mapping_file_path)
        print(name_mapping)
        patients = name_mapping["BraTS_2020_subject_ID"].tolist()
        print(patients)
