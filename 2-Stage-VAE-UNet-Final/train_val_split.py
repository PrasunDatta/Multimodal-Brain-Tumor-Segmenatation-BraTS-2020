...
with open('/content/gdrive/MyDrive/PrasunFolder/BraTS2020/Dataset/BraTS2020_TrainingData/train_list.txt', 'w') as f:
    for item in tr_HGG + tr_LGG:
        f.write("%s\n" % item)
with open('/content/gdrive/MyDrive/PrasunFolder/BraTS2020/Dataset/BraTS2020_TrainingData/valid_list.txt', 'w') as f:
