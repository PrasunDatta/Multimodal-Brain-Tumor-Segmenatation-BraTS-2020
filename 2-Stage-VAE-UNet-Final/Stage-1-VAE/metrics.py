...
class SoftDiceLoss(_Loss):
    ...
    def forward(self, y_pred, y_true, eps=1e-8):   # put 1,2,4 together   (2, 1, 4) 1+4: TC; 4:ET; 1+2+4: WT
        # print(f"Surute y_pred er shape: {y_pred.shape}")
        # print(f"Surute y_true er shape: {y_true.shape}")
        if self.new_loss:
        ...
        # print(f"Sesh y_pred er shape: {y_pred.shape}")
        # print(f"Sesh y_true er shape: {y_true.shape}")
        # p = torch.mul(y_pred, y_true)
        # print(p.shape)
